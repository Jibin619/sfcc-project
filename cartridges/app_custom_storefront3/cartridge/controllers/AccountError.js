...
server.post(
    ...
    function (req, res, next) {
        ...
        var registrationFormObj = {
            ...
            middleName: registrationForm.customer.middlename.htmlValue,
            lastName: registrationForm.customer.lastname.Value,
            phone: registrationForm.customer.phone.htmlValue,
            customphone:registrationForm.customer.Customphone.htmlValue,
            email: registrationForm.customer.email.htmlValue,
            emailConfirm: registrationForm.customer.emailconfirm.htmlValue,
            password: registrationForm.login.password.htmlValue,
            passwordConfirm: registrationForm.login.passwordconfirm.htmlValue,
                    ...
                    try {
                        Transaction.wrap(function () {
                            ...
                            if (!authenticatedCustomer) {
                                ...
                                newCustomerProfile.custom.secondname=registrationForm.middlename;
                                newCustomerProfile.lastName = registrationForm.lastName;
                                newCustomerProfile.phoneHome = registrationForm.phone;
                                newCustomerProfile.custom.mobile=registrationForm.customphone;
